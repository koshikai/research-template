...
if __package__ == "ai_research_template":
    warnings.warn(
        "You are using the default package name 'ai_research_template'. "
        "It is highly recommended to rename your project using:\n"
        "  uv run scripts/rename_project.py <new_name>",
        UserWarning,
        stacklevel=2,
    )
